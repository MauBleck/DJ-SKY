...
class CommandHandler extends common_1.BaseHandler {
    ...
    stablishSubCommandDefaults(commandInstance, option) {
        ...
        option.botPermissions = Permissions_1.PermissionsBitField.resolve([
            option.botPermissions ?? Permissions_1.PermissionsBitField.None,
            commandInstance.botPermissions ?? Permissions_1.PermissionsBitField.None,
        ]);
        option.defaultMemberPermissions ??= Permissions_1.PermissionsBitField.resolve([
            option.defaultMemberPermissions ?? Permissions_1.PermissionsBitField.None,
            commandInstance.defaultMemberPermissions ?? Permissions_1.PermissionsBitField.None,
        ]);
