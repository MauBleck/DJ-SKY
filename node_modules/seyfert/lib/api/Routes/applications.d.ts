    ...
    applications: (id: string) => {
        ...
        guilds: (id: string) => {
            commands: {
                ...
                post(args: RestArguments<RESTPostAPIApplicationGuildCommandsJSONBody>): Promise<RESTPostAPIApplicationGuildCommandsResult>;
                put(args?: RestArguments<RESTPutAPIApplicationGuildCommandsJSONBody>): Promise<RESTPutAPIApplicationGuildCommandsResult>;
                permissions: {
                ...
                (id: string): {
                    ...
                    patch(args: RestArguments<RESTPatchAPIApplicationGuildCommandJSONBody>): Promise<RESTPatchAPIApplicationGuildCommandResult>;
                    delete(args?: RestArgumentsNoBody): Promise<never>;
                    permissions: {
                        get(args?: RestArgumentsNoBody): Promise<RESTGetAPIGuildApplicationCommandsPermissionsResult>;
                        put(args?: RestArguments<RESTPutAPIApplicationCommandPermissionsJSONBody>): Promise<RESTPutAPIGuildApplicationCommandsPermissionsResult>;
                    };
                };
            };
        };
        commands: {
            ...
            (id: string): {
                ...
                patch(args: RestArguments<RESTPatchAPIApplicationCommandJSONBody>): Promise<RESTPatchAPIApplicationCommandResult>;
                delete(args?: RestArgumentsNoBody): Promise<never>;
            };
        };
        'role-connections': {
            metadata: {
                ...
                put(args: RestArguments<RESTPutAPIApplicationRoleConnectionMetadataJSONBody>): Promise<RESTPutAPIApplicationRoleConnectionMetadataResult>;
            };
        };
        emojis: {
            (id: string): {
            ...
            get(args?: RestArgumentsNoBody<Pick<RESTGetAPIApplicationEmojiResult, 'id'>>): Promise<RESTGetAPIApplicationEmojisResult>;
